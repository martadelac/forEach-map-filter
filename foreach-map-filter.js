...
//of objects, a key and a value, and returns the array passed 
//to the function with the new key and value added for each object 

Examples:
    addKeyAndValue([{name: 'Elie'}, {name: 'Tim'}, {name: 'Matt'}, {name: 'Colt'}],
    // 'title', 'instructor') [{name: 'Elie', title:'instructor'}, 
    //{name: 'Tim', title:'instructor'}, {name: 'Matt', title:'instructor'},
...
// keys as the vowel and the values as the number of times the vowel appears in the 
...
//     return obj;
// }
//:::::::::::::::::no lo he entendido bien pero esta es mi versión:::::::::::::
...
function vowelCount(str) {
  ...
  splitting.forEach(function (letter) {
...
Examples:   valTimesIndex([1,2,3]) // [0,2,6]
            valTimesIndex([1,-2,-3]) // [0,-2,-6]*/

function valTimesIndex(arr) {
  return arr.map(function (val, indice) {
    return val * indice;
  });
}
...
//Write a function called extractFullName that accepts an array of objects and returns a
//new array with the value of the key with a name of "first" and the value of
//a key with the name of "last" in each object, concatenated together with a space.
//Examples:      extractFullName([{first: 'Elie', last:"Schoppik"},
...
function extraeNombreCompleto(arr) {
  return arr.map(function (val) {
...
//element in the array that has the same value as the second parameter, or undefined 
